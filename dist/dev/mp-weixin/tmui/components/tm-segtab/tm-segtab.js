...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    common_vendor.watch(
      [() => props.modelValue],
      () => {
        if (_cId.value == props.modelValue)
          return;
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-4cd9ae76"], ["__file", "D:/zhidianUniapp/src/tmui/components/tm-segtab/tm-segtab.vue"]]);
