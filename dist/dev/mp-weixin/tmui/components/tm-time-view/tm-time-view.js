...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    function colchange(e) {
      let changedate = tmui_components_tmTimeView_time.getNowbyIndex(_col.value, e.detail.value, showCol.value, _startTime.value, _endTime.value);
      let testDate = tmui_components_tmTimeView_time.checkNowDateisBetween(changedate, _startTime.value, _endTime.value);
      let testRang = tmui_components_tmTimeView_time.rangeTimeArray(
        testDate,
        _startTime.value,
        _endTime.value,
        showCol.value
      ...
      colIndex.value = tmui_components_tmTimeView_time.getIndexNowbydate(testRang, _nowtime.value, showCol.value);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-dcacb728"], ["__file", "D:/zhidianUniapp/src/tmui/components/tm-time-view/tm-time-view.vue"]]);
